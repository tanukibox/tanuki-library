...
impl DomainEvent for CveDeletedEvent {
    fn event_type(&self) -> String {
        "com.tanukibox.cti.cve.deleted@1.0.0".to_string()
    }
}

impl Clone for CveDeletedEvent {
    fn clone(&self) -> Self {
